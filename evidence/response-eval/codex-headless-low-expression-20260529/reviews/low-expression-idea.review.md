# Converge Response Review Packet - low-expression-idea.md
...
```text
prompts/low-expression-idea.prompt.md
```

Result file:

```text
results/low-expression-idea.result.md
```
...
```markdown
# Converge Response Eval Result - low-expression-idea

## Metadata

- Case: low-expression-idea.md
- Verdict: TODO
- Evaluator:
- Model/Host:
- Date: 2026-05-29
