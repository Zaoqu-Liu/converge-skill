# Converge Response Review Packet - host-support-proof-boundary.md
...
```text
prompts/host-support-proof-boundary.prompt.md
```

Result file:

```text
results/host-support-proof-boundary.result.md
```
...
```markdown
# Converge Response Eval Result - host-support-proof-boundary

## Metadata

- Case: host-support-proof-boundary.md
- Verdict: TODO
- Evaluator:
- Model/Host:
- Date: 2026-05-29
