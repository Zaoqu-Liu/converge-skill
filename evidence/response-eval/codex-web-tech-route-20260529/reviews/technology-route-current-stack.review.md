# Converge Response Review Packet - technology-route-current-stack.md
...
```text
prompts/technology-route-current-stack.prompt.md
```

Result file:

```text
results/technology-route-current-stack.result.md
```
...
```markdown
# Converge Response Eval Result - technology-route-current-stack

## Metadata

- Case: technology-route-current-stack.md
- Verdict: TODO
- Evaluator:
- Model/Host:
- Date: 2026-05-29
