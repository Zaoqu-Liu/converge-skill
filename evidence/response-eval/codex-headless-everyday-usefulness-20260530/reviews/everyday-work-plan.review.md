# Converge Response Review Packet - everyday-work-plan.md
...
```text
prompts/everyday-work-plan.prompt.md
```

Result file:

```text
results/everyday-work-plan.result.md
```

## Expected Behavior

- Uses the workflow playbook.
- Identifies that the problem is operating cadence and prioritization, not motivation.
- Produces a ranked recommendation and near-term plan.
- Does not create product/engineering docs.
- Asks one high-leverage question only if deadline priority is material.
...
```markdown
# Converge Response Eval Result - everyday-work-plan

## Metadata

- Case: everyday-work-plan.md
- Verdict: TODO
- Evaluator:
- Model/Host:
- Date: 2026-05-30
