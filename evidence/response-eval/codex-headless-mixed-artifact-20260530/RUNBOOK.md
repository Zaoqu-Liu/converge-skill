...
Generated for: `mixed-artifact-intake.md`
...
```bash
python3 scripts/select_converge_response_eval_batch.py --mode pilot --max-cases 10 --runpack evidence/response-eval/codex-headless-mixed-artifact-20260530
```
...
```bash
python3 scripts/select_converge_response_eval_batch.py --mode next-cover --results-dir evidence/response-eval/codex-headless-mixed-artifact-20260530/results --require-real-results --runpack evidence/response-eval/codex-headless-mixed-artifact-20260530
```

12. Run the progress summary while filling results:

```bash
python3 scripts/summarize_converge_response_eval.py evidence/response-eval/codex-headless-mixed-artifact-20260530/results --require-real-results --show-axes
```

13. Run the validator from the skill root:

```bash
python3 scripts/check_converge_response_eval.py evidence/response-eval/codex-headless-mixed-artifact-20260530/results --require-all-cases --require-real-results
```
...
```bash
python3 scripts/check_converge_release.py --response-results-dir evidence/response-eval/codex-headless-mixed-artifact-20260530/results --require-response-results
```
