...
- Stored evidence under `evidence/response-eval/codex-headless-20260529`, `evidence/response-eval/codex-headless-choice-20260529`, `evidence/response-eval/codex-headless-host-proof-20260529`, and `evidence/response-eval/codex-web-tech-route-20260529` validates with `--require-real-results`.
